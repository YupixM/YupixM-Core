...
public class YCICPBItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		ComposterBlock.CHANCES.put(Blocks.CARROTS.asItem(), 0.2f);
		DispenserBlock.registerDispenseBehavior(Blocks.CARROTS.asItem(), new OptionalDispenseBehavior() {
