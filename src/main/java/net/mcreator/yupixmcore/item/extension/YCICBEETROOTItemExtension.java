...
public class YCICBEETROOTItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		ComposterBlock.CHANCES.put(Blocks.BEETROOTS.asItem(), 0.2f);
		DispenserBlock.registerDispenseBehavior(Blocks.BEETROOTS.asItem(), new OptionalDispenseBehavior() {
