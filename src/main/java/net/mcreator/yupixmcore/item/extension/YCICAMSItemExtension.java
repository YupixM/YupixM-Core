...
public class YCICAMSItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		ComposterBlock.CHANCES.put(Blocks.ATTACHED_MELON_STEM.asItem(), 0.2f);
		DispenserBlock.registerDispenseBehavior(Blocks.ATTACHED_MELON_STEM.asItem(), new OptionalDispenseBehavior() {
